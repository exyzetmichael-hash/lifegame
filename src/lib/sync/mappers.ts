...
export const activityRow = {
  toRow: (a: Activity) => ({
    ...
    color: a.color,
    icon: a.icon,
    stat_allocations: a.statAllocations,
  ...
  fromRow: (r: Record<string, unknown>): Activity => ({
    ...
    statAllocations: Array.isArray(r.stat_allocations) ? (r.stat_allocations as Activity['statAllocations']) : [],
...
export const sessionRow = {
  toRow: (s: TimeSession) => ({
    ...
    stat_allocations: s.statAllocations ?? null,
  }),
  fromRow: (r: Record<string, unknown>): TimeSession => ({
    ...
    xpAwarded: r.xp_awarded == null ? undefined : Number(r.xp_awarded),
    statAllocations: Array.isArray(r.stat_allocations) ? (r.stat_allocations as TimeSession['statAllocations']) : undefined,
  }),
};
...
export const habitRow = {
  toRow: (h: Habit) => ({
    ...
    unit: h.unit ?? null,
    schedule: h.schedule,
    stat_allocations: h.statAllocations,
  ...
  fromRow: (r: Record<string, unknown>): Habit => ({
    ...
    statAllocations: Array.isArray(r.stat_allocations) ? (r.stat_allocations as Habit['statAllocations']) : [],
...
export const xpEventRow = {
  toRow: (e: XpEvent) => ({
    ...
    amount: e.amount,
    reason: e.reason,
    stat_allocations: e.statAllocations ?? null,
  ...
  fromRow: (r: Record<string, unknown>): XpEvent => ({
    ...
    statAllocations: Array.isArray(r.stat_allocations) ? (r.stat_allocations as XpEvent['statAllocations']) : undefined,
    createdAt: r.created_at as string,
  }),
};
